sql = {
    ...
    1:"SELECT name, userName, userEmail, userPhone, userWebsite, street, suite, city, zipcode, geo_lat, geo_lng FROM USERS JOIN ADDRESS ON USERS.addressId = ADDRESS.addressId"
}
